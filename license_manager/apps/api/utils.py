...
def make_swagger_var_param_optional(result, generator=None, request=None, public=None):
    """
    Iterates through the result object generated by drf-spectacular
    and sets `allowEmptyValue=true` for `var` path param in swagger view
    """
